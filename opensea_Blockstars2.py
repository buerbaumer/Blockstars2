...
if endpoint == 'Assets':
    ...
    owner = st.sidebar.text_input("Owner", value = "0x811cf471f8fd11a434d27a343233434625d2d8a0")
    collection = st.sidebar.text_input("Collection", value = "")
    limit_n = st.sidebar.text_input("Limit", value = 15)
